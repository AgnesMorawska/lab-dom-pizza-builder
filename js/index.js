...
function renderButtons() {
  ...
  let buttons = document.querySelectorAll('.btn'); // selecting all btn

  buttons.forEach((button) => {
    let ingredientValue = button.dataset.ingredient //  dataset --> refers to the data that is in thr HTML
